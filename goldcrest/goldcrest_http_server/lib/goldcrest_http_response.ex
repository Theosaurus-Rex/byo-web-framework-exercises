defmodule Goldcrest.HTTPResponse do
  # Default headers to map type because HTTP headers need to have unique keys
  ...
  defp default_headers(body) do
    %{"content-type" => "text/html", "content-length" => byte_size(body)}
  end

  defp prep_headers(headers) do
    headers
    # Downcasing all our keys helps us check that they're unique
