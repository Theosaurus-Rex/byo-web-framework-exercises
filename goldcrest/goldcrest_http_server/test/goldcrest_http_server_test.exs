defmodule Goldcrest.HTTPServerTest do
  ...
  describe "start/2" do
    setup tags do
      ...
      on_exit(fn ->
        Application.put_env(:goldcrest_http_server, :responder, old_responder)
      end)
    ...
    test "raises when responder is not configured" do
      assert_raise(RuntimeError, "No `responder` configured for `goldcrest_http_server`", fn ->
